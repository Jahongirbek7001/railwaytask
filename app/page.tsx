      ...
      <div className="min-h-screen p-3 bg-gray-100">
        <div className=" w-full bg-white rounded-2xl p-5">
          ...
          <div className="overflow-x-auto">
            <div className="w-full inline-block shadow rounded-lg overflow-auto max-h-[400px]">
              <table className="w-full text-[10px] mx-auto bg-white border space-y-1 text-zinc-800">
                ...
                <tbody>
                  {options.map((option, index) => (
                    ...
                    >
                      <td className="px-3 py-6 xl:py-2 h-[100px] xl:h-[70px] border border-gray-300">{option.numbergu45}</td>
                      <td className="px-3 py-6 xl:py-2 h-[100px] xl:h-[70px] border border-gray-300">{option.page}</td>
                      <td className="px-3 py-6 xl:py-2 h-[100px] xl:h-[70px] border border-gray-300">{option.feedtype}</td>
                      <td className="px-3 py-6 xl:py-2 h-[100px] xl:h-[70px] border border-gray-300">{option.cargo}</td>
                      <td className="px-3 py-6 xl:py-2 h-[100px] xl:h-[70px] border border-gray-300">{option.branchowner}</td>
                      <td className="px-3 py-6 xl:py-2 h-[100px] xl:h-[70px] border border-gray-300">{option.vagon}</td>
                      <td className="px-3 py-6 xl:py-2 h-[100px] xl:h-[70px] border border-gray-300">{option.datecreate}</td>
                      <td className="px-3 py-6 xl:py-2 h-[100px] xl:h-[70px] border border-gray-300">{option.author}</td>
                      <td className="px-3 py-6 xl:py-2 h-[100px] xl:h-[70px] border border-gray-300">{option.numbergu46}</td>
                      <td className="px-3 py-6 xl:py-2 h-[100px] xl:h-[70px] border border-gray-300">{option.numberfdu92}</td>
                      <td className="px-3 py-6 xl:py-2 h-[100px] xl:h-[70px] border border-gray-300">{option.status}</td>
                      <td className="px-3 overflow-auto h-[100px] xl:h-[70px] border border-gray-300"><p className=" w-[100px]">{option.comment}</p></td>
